...
/**
 * This enum class lists all the locations in the board
 * Upper case character means the index in horizontal direction
 * Number means the index in vertical direction
 * Please refer to the picture of the game board in wiki page of Scrabble game
 * @author Chao
 */
public enum LocEnum {
